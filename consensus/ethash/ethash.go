...
// isLittleEndian returns whetzer the local system is running in little or big
// endian byte order.
...
// all blocks' seal as valid, though they still have to conform to the Ethzero
// consensus rules.
...
// still have to conform to the Ethzero consensus rules.
...
// they still have to conform to the Ethzero consensus rules.
