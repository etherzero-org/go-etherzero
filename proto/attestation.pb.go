...
type AttestationData struct {
	MasternodeBlockRoot      []byte      `protobuf:"bytes,1,opt,name=beacon_block_root,json=beaconBlockRoot,proto3" json:"beacon_block_root,omitempty" ssz-size:"32"`
...
func (m *AttestationData) GetMasternodeBlockRoot() []byte {
	if m != nil {
...
func init() {
	proto.RegisterFile("proto/attestation.proto", fileDescriptor_f8f395ba51cd84e0)
}
...
func (m *AttestationData) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MasternodeBlockRoot) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAttestation(dAtA, i, uint64(len(m.MasternodeBlockRoot)))
