...
var (
	...
	// ErrInsufficientPowers is returned if the total cost of executing a transaction
	// is higher than the balance of the user's account.
	ErrInsufficientPowers = errors.New("insufficient funds for power * price + value")
