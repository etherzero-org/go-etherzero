...
func (NoopStateDB ) SetHeightTxCount(heighttxcount uint64){}

func (NoopStateDB) HeightTxCount() uint64 {return 0}

func (NoopStateDB) SetTxBlockHeight(txblockheight big.Int){}

func (NoopStateDB) TxBlockHeight() big.Int {return big.Int{} }
