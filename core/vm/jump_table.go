...
type operation struct {
	...
	halts   bool // indicates whetzer the operation should halt further execution
	jumps   bool // indicates whetzer the program counter should not increment
	writes  bool // determines whetzer this a state modifying operation
	valid   bool // indication whetzer the retrieved operation is valid and known
	reverts bool // determines whetzer the operation reverts state (implicitly halts)
	returns bool // determines whetzer the operations sets the return data content
}
...
var (
	...
	ethzeroInstructionSet = NewEthzeroInstructionSet()
)

// NewEthzeroInstructionSet returns the frontier, byzantium and
// Ethzero instructions.
func NewEthzeroInstructionSet() [256]operation {
