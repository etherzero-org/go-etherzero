...
/*
bzz implements the swarm wire protocol [bzz] (sister of etz and shh)
...
import (
	...
	bzzswap "github.com/ethzero/go-ethzero/swarm/services/swap"
	"github.com/ethzero/go-ethzero/swarm/services/swap/swap"
