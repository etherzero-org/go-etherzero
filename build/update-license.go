...
var (
	...
	authorsFileHeader = "# This is the official list of go-ethzero authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ethzero Authors
