...
# 1. install getz for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for getz
# 5. create getz, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ETHZERO_SOCKET
...
!define GROUPNAME "Ethzero"
!define APPNAME "Getz"
!define DESCRIPTION "Official Go implementation of the Ethzero protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since getz is installed global
