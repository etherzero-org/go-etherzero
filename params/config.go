...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EthzeroGenesisBlock: big.NewInt(59204),
		EthzeroTOSBlock:     big.NewInt(59205),
		EthzeroBlock:        big.NewInt(59206),
		EthzeroMasternodeBlock: big.NewInt(59207),
	...
	TestnetChainConfig = &ChainConfig{
		...
		EthzeroTOSBlock:     big.NewInt(0),
		EthzeroBlock:        big.NewInt(0),
		EthzeroGenesisBlock: big.NewInt(0),
		ConstantinopleBlock: nil,
		Ethash:              new(EthashConfig),
	}
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Ethzero: %v Masternode: %v Constantinople: %v Engine: %v}",
		c.ChainId,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
func (c *ChainConfig) IsEthzeroMasternode(num *big.Int) bool {
	return isForked(c.EthzeroMasternodeBlock, num)
}
