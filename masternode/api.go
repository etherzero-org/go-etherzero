...
type PrivateAdminAPI struct {
	node *Masternode // Node interfaced by this API
}

// NewPrivateAdminAPI creates a new API definition for the private admin methods
// of the node itself.
func NewPrivateAdminAPI(node *Masternode) *PrivateAdminAPI {
...
// of the node itself.
func NewPublicAdminAPI(node *Masternode) *PublicAdminAPI {
...
// of the node itself.
func NewPublicDebugAPI(node *Masternode) *PublicDebugAPI {
...
func NewPublicWeb3API(stack *Masternode) *PublicWeb3API {
