...
// Status implements accounts.Wallet, returning whetzer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain ethzero.ChainStateReader) {}
