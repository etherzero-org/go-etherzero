...
func TestURLParsing(t *testing.T) {
	url, err := parseURL("https://etherzero.org")
	if err != nil {
...
func TestURLString(t *testing.T) {
	...
	if url.String() != "https://etherzero.org" {
		t.Errorf("expected: %v, got: %v", "https://etherzero.org", url.String())
	}
...
func TestURLMarshalJSON(t *testing.T) {
	...
	if string(json) != "\"https://etherzero.org\"" {
		t.Errorf("expected: %v, got: %v", "\"https://etherzero.org\"", string(json))
	}
}

func TestURLUnmarshalJSON(t *testing.T) {
	url := &URL{}
	err := url.UnmarshalJSON([]byte("\"https://etherzero.org\""))
	if err != nil {
		t.Errorf("unexpcted error: %v", err)
	}
	if url.Scheme != "https" {
