...
import (
	...
	"github.com/ethzero/go-ethzero/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Ethzero contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Ethzero contract bytecode (generate deploy Method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Ethzero contract Solidity source to build and bind")
