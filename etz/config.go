...
// DefaultConfig contains default settings for use on the Ethzero main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, "AppData", "Ethashzero")
	} else {
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, ".ethashzero")
	}
}
...
type Config struct {
	...
	// If nil, the Ethzero main net block is used.
	...
	Etzerbase    common.Address `toml:",omitempty"`
