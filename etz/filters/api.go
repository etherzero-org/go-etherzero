...
// information related to the Ethzero protocol such als blocks, transactions and logs.
...
// `etz_getFilterChanges` polling Method that is also used for log filters.
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with etz_getFilterChanges.
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_newblockfilter
...
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_newfilter
...
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_getlogs
...
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_uninstallfilter
...
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_getfilterlogs
...
//
// https://github.com/ethzero/wiki/wiki/JSON-RPC#etz_getfilterchanges
