...
// PeerInfo represents a short summary of the Ethzero sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Ethzero protocol version negotiated
...
// Handshake executes the etz protocol handshake, negotiating version number,
