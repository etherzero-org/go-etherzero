...
type downloadTester struct {
	...
	stateDb etzdb.Database // Database used by the tester for syncing from peers
	peerDb  etzdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = etzdb.NewMemDatabase()
