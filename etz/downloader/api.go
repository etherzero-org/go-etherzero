...
// Syncing provides information when this nodes starts synchronising with the Ethzero network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ethzero.SyncProgress `json:"status"`
}
