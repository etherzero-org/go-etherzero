...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (etz/61) or header (etz/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (etz/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both etz/61 and etz/62)
}
...
func (f *Fetcher) insert(peer string, block *types.Block) {
	...
	go func() {
		...
		default:
			// Sometzing went very wrong, drop the peer
