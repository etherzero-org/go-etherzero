...
// Supported versions of the etz protocol (first is primary).
var ProtocolVersions = []uint{etz63, etz62}
...
// etz protocol message codes
const (
	// Protocol messages belonging to etz/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to etz/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
