...
var (
	...
	miscInPacketsMeter        = metrics.NewMeter("etz/misc/in/packets")
	miscInTrafficMeter        = metrics.NewMeter("etz/misc/in/traffic")
	miscOutPacketsMeter       = metrics.NewMeter("etz/misc/out/packets")
	miscOutTrafficMeter       = metrics.NewMeter("etz/misc/out/traffic")
)
...
func (rw *meteredMsgReadWriter) ReadMsg() (p2p.Msg, error) {
	...
	case rw.version >= etz63 && msg.Code == NodeDataMsg:
		packets, traffic = reqStateInPacketsMeter, reqStateInTrafficMeter
	case rw.version >= etz63 && msg.Code == ReceiptsMsg:
