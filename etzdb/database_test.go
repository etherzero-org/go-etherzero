...
func newTestLDB() (*etzdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "etzdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := etzdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db etzdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db etzdb.Database, t *testing.T) {
	const n = 8
