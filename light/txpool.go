...
// to the ETZ network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whetzer a transaction is valid according to the consensus rules.
